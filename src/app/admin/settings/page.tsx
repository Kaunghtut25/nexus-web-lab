...
export default function SettingsPage() {
  ...
  const fields = [
    ...
    {k:'contactEmail',l:'Contact Email'},{k:'contactPhone',l:'Contact Phone (e.g. 09945598825)'},{k:'contactPhoneDisplay',l:'Contact Phone (display, e.g. 09945598825)'},{k:'businessHours',l:'Business Hours'},
    // Social Links
