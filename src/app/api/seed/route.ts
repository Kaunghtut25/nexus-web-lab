...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const testimonials = [
      ...
      { id: "t2", name: "J Recruit Co., Ltd.", role: "Recruitment Platform", company: "J Recruit", content: "Professional recruitment platform with job board and referral system. Clean code, fast delivery, excellent support.", rating: 5, avatar: "", logo: "/images/jrecruit-logo.svg", sort_order: 2 },
      { id: "t3", name: "Stardust.co", role: "E-Commerce", company: "Stardust", content: "Our e-commerce store with AI live chat exceeded expectations. Sales increased within the first month.", rating: 5, avatar: "", logo: "/images/stardust-logo.webp", sort_order: 3 },
      ...
      { id: "t5", name: "Azami Training Center", role: "Education & Training", company: "Azami", content: "Azami Training Center needed a bilingual education platform. Nexus delivered course listings, job board and a full admin panel.", rating: 5, avatar: "", logo: "/images/azami-logo.svg", sort_order: 5 },
